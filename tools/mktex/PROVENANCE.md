...
Dark decompilation is MIT-licensed; keep that attribution when modifying this
area. The rest of this directory is project-specific conversion glue unless a
file-level notice says otherwise.
