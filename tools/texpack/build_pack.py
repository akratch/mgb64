...
def main():
    ...
    ap.add_argument("--plan", help="route_pack.py plan.json (used by --distributable; "
                                   "the full plan-driven build lands in W2.E2.T3)")
    ...
    if args.distributable:
        ...
        # Nothing further to build here; the plan-driven build is W2.E2.T3.
        print("  (gate check only; plan-driven build lands in W2.E2.T3)")
        return
